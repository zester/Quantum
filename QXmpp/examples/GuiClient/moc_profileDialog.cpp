...
static const char qt_meta_stringdata_profileDialog[] = {
    "profileDialog\0\0versionReceived(QXmppVersionIq)\0"
...
int profileDialog::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: versionReceived((*reinterpret_cast< const QXmppVersionIq(*)>(_a[1]))); break;
        case 1: timeReceived((*reinterpret_cast< const QXmppEntityTimeIq(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 2;
    }
