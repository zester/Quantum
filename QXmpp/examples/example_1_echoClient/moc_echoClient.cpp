...
**
** Created: Sun Sep 4 07:30:00 2011
...
static const char qt_meta_stringdata_echoClient[] = {
    "echoClient\0\0messageReceived(QXmppMessage)\0"
};

const QMetaObject echoClient::staticMetaObject = {
    { &QXmppClient::staticMetaObject, qt_meta_stringdata_echoClient,
      qt_meta_data_echoClient, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &echoClient::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_echoClient))
...
int echoClient::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: messageReceived((*reinterpret_cast< const QXmppMessage(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 1;
    }
