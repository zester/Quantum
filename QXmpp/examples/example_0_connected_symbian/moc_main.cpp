...
**
** Created: Sun Sep 4 07:29:58 2011
...
const QMetaObject &LogViewer::getStaticMetaObject() { return staticMetaObject; }
...
int LogViewer::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: log((*reinterpret_cast< QXmppLogger::MessageType(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2]))); break;
        default: ;
        }
        _id -= 1;
    }
