...
**
** Created: Sun Sep 4 07:30:11 2011
...
static const char qt_meta_stringdata_xmppClient[] = {
    "xmppClient\0\0clientConnected()\0"
    "rosterReceived()\0vCardReceived(QXmppVCardIq)\0"
};
...
int xmppClient::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: vCardReceived((*reinterpret_cast< const QXmppVCardIq(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 3;
    }
